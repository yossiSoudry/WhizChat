...
function Tabs({
  ...
  return (
    ...
    >
      <div data-slot="tabs" dir={dir} {...props}>
        {children}
      </div>
    </TabsProvider>
  );
...
function TabsContents({
  ...
  // For RTL, we need to reverse the animation direction
  const xOffset = dir === 'rtl' ? activeIndex * 100 : activeIndex * -100;
