(function() {
  ...
  function createStyles() {
    ...
    style.textContent = `
      ...
      .whizchat-whatsapp-banner:hover {
        background: linear-gradient(135deg, #22c55e, #16a34a);
      }

      .whizchat-whatsapp-icon {
        width: 20px;
        height: 20px;
        flex-shrink: 0;
      }

      .whizchat-whatsapp-text {
        flex: 1;
        font-size: 13px;
        font-weight: 500;
      }

      .whizchat-whatsapp-arrow {
        width: 16px;
        height: 16px;
        opacity: 0.8;
        flex-shrink: 0;
  ...
  function createWidget() {
    ...
    container.innerHTML = `
      ...
      <div class="whizchat-window" id="whizchat-window">
        ...
        <div id="whizchat-whatsapp-banner" class="whizchat-whatsapp-banner" style="display: none;">
          <svg class="whizchat-whatsapp-icon" viewBox="0 0 24 24" fill="currentColor">
          ...
          <span class="whizchat-whatsapp-text">Continue on WhatsApp</span>
          <svg class="whizchat-whatsapp-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  function updateStatus() {
    ...
    // Show/hide WhatsApp banner based on phone availability
    var whatsappBanner = document.getElementById('whizchat-whatsapp-banner');
    if (whatsappBanner) {
      whatsappBanner.style.display = state.whatsappPhone ? 'flex' : 'none';
    }
  }
  ...
  function initChat() {
    ...
    .then(function(data) {
      ...
      // Get WhatsApp business phone
      if (data.settings.whatsappPhone) {
        state.whatsappPhone = data.settings.whatsappPhone;
      }
  ...
  function bindEvents() {
    ...
    // WhatsApp banner click handler
    document.getElementById('whizchat-whatsapp-banner').onclick = function() {
      if (state.whatsappPhone) {
        var phone = state.whatsappPhone.replace(/[^0-9]/g, '');
        var message = encodeURIComponent("Hello, I came through your website and would appreciate your assistance with the following matter:");
